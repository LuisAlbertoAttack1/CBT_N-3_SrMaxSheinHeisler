...
<div class="container mt-5">
    <h1 class="GosorDeLetraHome text-center mt-4" data-aos="zoom-in"><b><i class="fa-regular fa-clock text-verde2 me-2"></i>Añadir horario</b></h1>
    <hr class="border-success border-3 mt-4 mb-3" data-aos="zoom-in">
    <h3 class="mt-4 mb-4" data-aos="zoom-in"><b>Datos Materia</b></h3>
        ...
        <form id="frm_crear_horario" method="post" action="{{route('horario.add')}}" class="row justify-content-around">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-floating mb-3 shadow-sm">
                            <input type="text" class="form-control rounded" name="grupo" id="grupo" placeholder="Grupo">
                    ...
                    <div class="col-md-4">
                        ...
                        @enderror 
                        <div class="form-floating mb-3 shadow-sm">
                            <select name="carrera" id="carrera" class="form-control rounded" value="{{old('carrera')}}">
                    ...
                    <div class="col-md-4">
                        ...
                        @enderror 
                        <div class="form-floating mb-3 shadow-sm">
                            <select name="semestre" id="semestre" class="form-control rounded" value="{{old('semestre')}}">
                    ...
                    <div class="col-md-5">
                        ...
                        @enderror 
                        <div class="form-floating mb-3 shadow-sm">
                            <select name="materia" id="materia" class="form-control rounded" value="{{old('materia')}}">
                    ...
                    <div class="col-md-4">
                        ...
                        @enderror 
                        <div class="form-floating mb-3 shadow-sm">
                            <select name="docente" id="docente" class="form-control rounded" value="{{old('docente')}}">
            ...
            <div class="col-12 mb-3">
                <div class="row">
                    <div class="col-12">
                        <hr class="border-success border-3 mt-4 mb-3" data-aos="zoom-in">
                        <h3 class="mt-4 mb-4"><b>Horarios clase</b></h3>
                    </div>
                    <div class="col-lg-12">
                                            ...
                                            <td>
                                                <div class="container">
                                                    <div class="row my-2">
                                                        <div class="col-lg-12 text-center">
                                                            <div class="input-group mb-2 shadow-sm">
                                                                <select class="form-select rounded" name="hora_inicio{{$i}}" id="hora_inicio{{$i}}">
                                                                    <option value="">--:--</option>
                                                    ...
                                                    <div class="row my-2">
                                                        <div class="col-lg-12 text-center">
                                                            <div class="input-group mb-2 shadow-sm">
                                                                <select class="form-select rounded" name="hora_fin{{$i}}" id="hora_fin{{$i}}"></select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
